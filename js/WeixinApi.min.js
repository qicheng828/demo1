var WeixinApi = (function () {
    ...
    function weixinShareWeibo(data, callbacks) {
        ...
        var shareWeibo = function (theData) {
            WeixinJSBridge.invoke('shareWeibo', {"content": theData.desc, "url": theData.link}, function (resp) {
                switch (resp.err_msg) {
    ...
    function addContact(appWeixinId, callbacks) {
        callbacks = callbacks || {};
        WeixinJSBridge.invoke("addContact", {webtype: "1", username: appWeixinId}, function (resp) {
...
WeixinApi.ready(function (Api) {
    var wxData = {
        "appId": "",
        "imgUrl": 'http://m.xiaoquyijia.com/lottery/images/share.jpg',
        "link": 'http://m.xiaoquyijia.com/lottery/',
        "desc": '即刻奏响保利感恩活动，1818欢乐多多，iphone7免费等你拿',
        "title": "好礼任性抽，幸运一整年"
    };
...
var server="http\://115.29.198.70/";
//var server="http://test.lcsw.cn:8027/";